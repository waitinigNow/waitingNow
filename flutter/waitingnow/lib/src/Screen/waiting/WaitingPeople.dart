                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: TextButton(
                                          onPressed: () {
                                            if(waitingGet.adult.value + waitingGet.baby.value == 0){
                                              show("오류", "인원을 등록해주세요");
                                            }
                                            else{
                                              waitingController.registWaiting()
                                                  .then((value) {
                                                print("[웨이팅 완료 페이지] 웨이팅 완료 페이지로 이동합니다.");
                                                Get.to(() => WaitingComplete(), arguments: value);
                                              });
                                            }
                                          },
                                          child: Text(
